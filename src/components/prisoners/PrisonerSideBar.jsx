...
import prisoners_active from '../../assets/people_active.svg'
      ...
      <div className="inner-content justify-content-center mt-4 mx-2">
        ...
        <div className="links-container mx-3 mt-5">
          ...
          <div className="inactive-links">
             {/* Active Link */}
            <div className="active-link-cover d-flex align-items-center mt-1 gap-2 px-3 mt-2" >
              <NavLink exact to="/prisoners" className="text-white fw-semibold fs-6 "  style={{fontFamily:'Montserrat'}}>
                <img src={prisoners_active} alt="" className='img-fluid mx-3' />
                Prisoners
              </NavLink>
            </div>
...
export default PrisonerSideBar