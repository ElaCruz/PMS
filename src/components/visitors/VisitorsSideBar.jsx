...
import visitors_active from '../../assets/visitors_active.svg'
import guards from '../../assets/guards.svg'
import setting from '../../assets/setting.svg'
import logout from '../../assets/logout.svg'

function VisitorsSideBar() {
  return (
        ...
        <div className="links-container mx-3 mt-5">
          ...
          <div className="inactive-links">
            ...
            <div className="inactive-link-cover d-flex align-items-center mt-1 gap-2 ps-3 " >
              ...
              {/* Active Link */}
            <div className="active-link-cover d-flex align-items-center mt-1 gap-2 px-3" >
              <NavLink exact to="/visitors" className="active-link  text-white fw-semibold  fs-6"  style={{fontFamily:'Montserrat'}}>
                <img src={visitors_active} alt="" className='img-fluid mx-3' />
                Visitors
              </NavLink>
            </div>
...
export default VisitorsSideBar