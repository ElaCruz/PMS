...
import setting_active from '../assets/setting_active.svg'
        ...
        <div className="links-container mx-3 mt-5">
          ...
          <div className="inactive-links">
            ...
            <div className="active-link-cover d-flex align-items-center mt-1 gap-2 px-3" >
              <NavLink exact to="/setting" className=" active-link text-white fw-semibold  fs-6"  style={{fontFamily:'Montserrat'}}>
                <img src={setting_active} alt="" className='img-fluid mx-3' />
                Settings
              </NavLink>
            </div>
