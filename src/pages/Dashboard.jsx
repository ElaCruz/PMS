...
function Dashboard() {
  ...
  // The UseEffect for recent prisoners
  useEffect(() => {
    fetch("http://localhost:8000/api/prisoners/?limit=3&order_by=-date_added")
      .then((response) => response.json())
      .then((data) => {
        setRecentPrisoners(data);
      })
      .catch((error) => {
      ...
      <div className="main d-none d-lg-flex">
        ...
        <div className="dashboard-content">
          ...
          <div className="mainthings-section">
            <h4 className="welcome-text text-start me-3">
              Welcome Back, Lilian !
            </h4>
            <div className="main-container">
              ...
              <div className="d-flex mt-4 gap-4">
                ...
                <div className=" small-box d-flex  ps-2 position-relative justify-content-start align-items-center bg-white ">
                  <img
                    ...
                    alt=""
                    className="thing-icons img-fluid"
                  />
                  <div
                    className="d-flex flex-column text-start ms-2"
                    style={{ fontFamily: "Montserrat", color: "#5a5a5a" }}
                  >
                    <p className="total-things">Total Prisoners</p>
                    <h4 className="numberof-things fw-semibold position-absolute">
                      0{prisonerCount}
                    </h4>
                  </div>
                </div>
              ...
              <div className="dashboard-graphs-container  d-flex gap-3 ">
                {/* Visitor's graph */}
                <div
                  className="bg-white text-start fs-5 justify-content-start p-3 d-flex flex-column h-100"
                ...
                <div
                  className="bg-white fs-5  p-3 d-flex flex-column"
                  style={{
                    width: "380px",
                    borderRadius: "20px",
              ...
              <div className="dashboard-last-section d-flex gap-3">
                <div
                  className="bg-white text-start p-3 fs-5 d-flex flex-column "
                ...
                >
                  Recently Added Prisoners
                   {/* Recently added prisoners here*/}
                  <div className="d-flex flex-column justify-content-center mt-2">
                    {[...recentPrisoners].reverse().map((prisoner) => (
                      <div
                        key={prisoner.id}
                        className="recent-prisoners d-flex align-items-center gap-3 my-2"
                      >
                        <img src={prisoner.photo} alt="prisoner_photo" />
                        <p>
                          {prisoner.first_name} {prisoner.last_name}
                        </p>
                        <p>{prisoner.gender_name}</p>
                        <p>{prisoner.cell_name}</p>
                      </div>
                    ))}
                  </div>
                  {/* End of Recently Added Prisoners */}
